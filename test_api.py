...
class KikBotApiTest(TestCase):
    def setUp(self):
        ...
        self.api = KikApi('helper_of_jonathan', '22558275-75ae-4a7d-9e53-875935557895')
    ...
    def test_send_messages(self, post):
        ...
        self.assertEqual(post_call[1]['auth'], ('helper_of_jonathan', '22558275-75ae-4a7d-9e53-875935557895'))
    ...
    def test_get_user_profile(self, get):
        ...
        get.assert_called_once_with(
            ...
            auth=('helper_of_jonathan', '22558275-75ae-4a7d-9e53-875935557895'),
            timeout=60
        )
    ...
    def test_set_configuration(self, post):
        ...
        self.assertEqual(post.call_args[1]['auth'], ('helper_of_jonathan', '22558275-75ae-4a7d-9e53-875935557895'))
